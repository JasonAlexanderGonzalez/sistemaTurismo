...
<style>
    .card {
        ...
        width: 250px;
        height: 320px;
        background-image: linear-gradient(to right, #254117, #99C68E, #254117);
...
<body class="montaña" id="page-top">
 ...
 <!-- Services-->
    ...
    <section class="page-section bg-light" id="portfolio">
        <div class="container" style=" background-image: linear-gradient(to right, #4AA02C, #7BCCB5, #4AA02C)">
            <div class="text-center">
                <br>
                <h2 class="section-heading text-uppercase animated-title">Montañas</h2>
    ...
    <div class="col-lg-4 col-sm-6 mb-4">
        <div class="card">
            <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal{{ $montaña->id }}">
                ...
                <img class="card-img-top" src="data:image/jpeg;base64,{{ base64_encode($montaña->imagen) }}" alt="{{ $montaña->nombre }}" />
            </a>
            <div class="card-body">
                <p class="card-title">{{ $montaña->nombre }}</p>
                <p class="card-text">{{ $montaña->categoria }}</p>
