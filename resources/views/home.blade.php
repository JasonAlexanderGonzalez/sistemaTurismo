...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css"
        integrity="sha384-GLhlTQ8iKSeLeMzXJF3eDJPJ2CBpd0+2Dz+td2EnfddF83/3Zj47EJVoUpFhNIlM" crossorigin="anonymous">
...
<style>
 .card {
    ...
    width: 250px;
    height: 320px;
    background-image: linear-gradient(to right, #6D7B8D, #FFFFFF, #6D7B8D);
...
<body class="home" id="page-top">
    <div>
                    ...
                    <div class="col-lg-4 col-sm-6 mb-4">
                        <div class="card">
                            <a class="portfolio-link" data-bs-toggle="modal"
                                href="#portfolioModal{{ $preferencia->id }}">
                                <div class="portfolio-hover">
                                    <div class="portfolio-hover-content"><i class="fas fa-plus fa-3x"></i></div>
                                </div>
                                <img class="img-fluid"
                                    src="data:image/jpeg;base64,{{ base64_encode($preferencia->imagen) }}"
                            ...
                            <div class="portfolio-description" id="descripcion{{ $preferencia->id }}"
                                style="display: none;">
        ...
        @foreach ($preferencias as $preferencia)
        <div class="portfolio-modal modal fade" id="portfolioModal{{ $preferencia->id }}" tabindex="-1" role="dialog"
            aria-hidden="true">
            <div class="modal-dialog" style="max-width: 500px;">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p class="text-uppercase">{{ $preferencia->nombre }}</p>
    ...
    <div class="col-lg-4 col-sm-6 mb-4">
        <div class="card">
            <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal{{ $recomendacione->id }}">
                ...
                <img class="card-img-top" src="data:image/jpeg;base64,{{ base64_encode($recomendacione->imagen) }}"
                    alt="{{ $recomendacione->nombre }}" />
            </a>
            <div class="card-body">
                <p class="card-title">{{ $recomendacione->nombre }}</p>
                <p class="card-text">{{ $recomendacione->categoria }}</p>
            </div>
        </div>
    </div>
@endforeach
        ...
        @foreach ($recomendaciones as $recomendacione)
        <div class="portfolio-modal modal fade" id="portfolioModal{{ $recomendacione->id }}" tabindex="-1" role="dialog"
            aria-hidden="true">
            <div class="modal-dialog" style="max-width: 500px;">
                <div class="modal-content">
                    <div class="modal-header">
